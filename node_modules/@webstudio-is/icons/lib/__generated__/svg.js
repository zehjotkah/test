...
var InfoCircleIcon = `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 16" width="100%" height="100%" style="display: block;"><path d="M8 13.35a5.35 5.35 0 1 0 0-10.7 5.35 5.35 0 0 0 0 10.7ZM14.65 8a6.65 6.65 0 1 1-13.3 0 6.65 6.65 0 0 1 13.3 0Z" clip-rule="evenodd"/><path d="M8.8 4.913a.8.8 0 0 1-.8.8h-.009a.8.8 0 0 1 0-1.6H8a.8.8 0 0 1 .8.8ZM8 11.737a.65.65 0 0 1-.65-.65v-3.43a.65.65 0 1 1 1.3 0v3.43a.65.65 0 0 1-.65.65Z" clip-rule="evenodd"/></svg>`;
...
var MinimizeIcon = `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 16" width="100%" height="100%" style="display: block;"><path d="M14.46 2.54a.65.65 0 0 1 0 .92L11.29 6.628h2.098a.65.65 0 1 1 0 1.3H9.722a.65.65 0 0 1-.65-.65V3.61a.65.65 0 1 1 1.3 0V5.71L13.54 2.54a.65.65 0 0 1 .92 0ZM2.96 9.722a.65.65 0 0 1 .65-.65h3.667a.65.65 0 0 1 .65.65v3.667a.65.65 0 0 1-1.3 0V11.29L3.46 14.46a.65.65 0 0 1-.92-.92l3.169-3.168H3.61a.65.65 0 0 1-.65-.65Z" clip-rule="evenodd"/></svg>`;
...
var NavigatorIcon = `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 16" width="100%" height="100%" style="display: block;"><path d="M4 11.35a.65.65 0 0 1 .65-.65h9.367a.65.65 0 1 1 0 1.3H4.65a.65.65 0 0 1-.65-.65ZM4 7.896a.65.65 0 0 1 .65-.65h9.367a.65.65 0 1 1 0 1.3H4.65a.65.65 0 0 1-.65-.65ZM1.334 4.441a.65.65 0 0 1 .65-.65h9.367a.65.65 0 1 1 0 1.3H1.983a.65.65 0 0 1-.65-.65Z" clip-rule="evenodd"/></svg>`;
...
var SettingsIcon = `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 16" width="100%" height="100%" style="display: block;"><path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.3" d="M2 5.333h8m0 0a2 2 0 1 0 4 0 2 2 0 0 0-4 0Zm-4 5.334h8m-8 0a2 2 0 1 1-4 0 2 2 0 0 1 4 0Z"/></svg>`;
var ShadowInsetIcon = `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 14" width="100%" height="100%" style="display: block;"><path fill="currentColor" fill-rule="evenodd" d="M1.65 7a5.35 5.35 0 1 1 10.7 0 5.35 5.35 0 0 1-10.7 0ZM7 .35a6.65 6.65 0 1 0 0 13.3A6.65 6.65 0 0 0 7 .35ZM4.315 7a2.685 2.685 0 0 1 5.37 0 .65.65 0 1 0 1.3 0 3.985 3.985 0 1 0-7.97 0 .65.65 0 0 0 1.3 0Z" clip-rule="evenodd"/></svg>`;
var ShadowNormalIcon = `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 12 14" width="100%" height="100%" style="display: block;"><path fill="currentColor" fill-rule="evenodd" d="M1.985 5.665a4.015 4.015 0 1 1 8.03 0 4.015 4.015 0 0 1-8.03 0ZM6 .35a5.315 5.315 0 1 0 0 10.63A5.315 5.315 0 0 0 6 .35Zm5.64 10.957a.65.65 0 0 0-.919-.919 6.681 6.681 0 0 1-9.448.006.65.65 0 1 0-.92.919c3.116 3.116 8.17 3.112 11.288-.006Z" clip-rule="evenodd"/></svg>`;
...
var UpgradeIcon = `<svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 16 16" width="100%" height="100%" style="display: block;"><path fill-rule="evenodd" d="M8 2.65a5.35 5.35 0 1 0 0 10.7 5.35 5.35 0 0 0 0-10.7ZM1.35 8a6.65 6.65 0 1 1 13.3 0 6.65 6.65 0 0 1-13.3 0Z" clip-rule="evenodd"/><path fill-rule="evenodd" d="M7.54 4.874a.65.65 0 0 1 .92 0l2.666 2.666a.65.65 0 0 1-.919.92L8.65 6.903v3.764a.65.65 0 1 1-1.3 0V6.903L5.793 8.46a.65.65 0 1 1-.92-.92L7.54 4.874Z" clip-rule="evenodd"/></svg>`;
var UploadIcon = `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 16" width="100%" height="100%" style="display: block;"><path fill="currentColor" fill-rule="evenodd" d="M3.315 4.642a4.852 4.852 0 0 1 9.37 0 3.801 3.801 0 0 1 1.277 6.868.65.65 0 0 1-.724-1.08 2.5 2.5 0 0 0-1.154-4.569.65.65 0 0 1-.581-.542 3.551 3.551 0 0 0-7.006 0 .65.65 0 0 1-.581.542 2.5 2.5 0 0 0-1.154 4.568.65.65 0 1 1-.724 1.08 3.801 3.801 0 0 1 1.276-6.868ZM7.35 9.57l-1.69 1.69a.65.65 0 0 1-.92-.919l2.8-2.8a.65.65 0 0 1 .92 0l2.8 2.8a.65.65 0 1 1-.92.92L8.65 9.57v4.73a.65.65 0 1 1-1.3 0V9.57Z" clip-rule="evenodd"/></svg>`;
...
var ZAxisRotateIcon = `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 16" width="100%" height="100%" style="display: block;"><path fill="#231F20" d="M14 9.51a.5.5 0 0 0-1 0h1ZM9.94 4.896a.5.5 0 0 0 .392-.92l-.391.92Zm.07-4.148a.5.5 0 0 0-.876.483l.875-.483Zm1.74 4.184.241.438a.5.5 0 0 0 .196-.68l-.438.242Zm-4.185 1.74a.5.5 0 1 0 .484.876l-.484-.876ZM13 9.51c0 2.757-2.244 5-5 5v1c3.309 0 6-2.69 6-6h-1Zm-5 5c-2.756 0-5-2.243-5-5H2c0 3.31 2.691 6 6 6v-1Zm-5-5c0-2.756 2.244-5 5-5v-1c-3.309 0-6 2.692-6 6h1Zm5-5c.692 0 1.356.139 1.94.388l.392-.92A5.973 5.973 0 0 0 8 3.509v1Zm1.134-3.277 2.178 3.943.875-.484L10.009.75l-.875.483Zm2.374 3.263L7.565 6.673l.484.876L11.99 5.37l-.483-.876Z"/></svg>`;
var ZAxisIcon = `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 16" width="100%" height="100%" style="display: block;"><path fill="#231F20" d="M14.583 9.096H6.079V1.012A.507.507 0 0 0 5.567.5a.507.507 0 0 0-.513.512v8.545L1.94 13.79v-2.982a.507.507 0 0 0-.513-.512.507.507 0 0 0-.512.512v4.17c0 .287.225.513.502.513h4.13v.01a.507.507 0 0 0 .511-.512.507.507 0 0 0-.512-.513H2.708l3.197-4.354h8.668a.507.507 0 0 0 .512-.512.507.507 0 0 0-.512-.513h.01Z"/></svg>`;
export {
  ACCenterIcon,
  ACEndIcon,
  ACSpaceAroundIcon,
